...
net.setInputs(false, Array(false, false, false, false))
sim.simulate(0.05, 1000)
net.setInputs(false, Array(true, true, false, false))
sim.simulate(0.05, 10000)
net.setInputs(false, Array(false, false, false, false))
sim.simulate(0.05, 1000)
net.setInputs(false, Array(false, true, true, false))
sim.simulate(0.05, 10000)
net.setInputs(false, Array(false, false, false, false))
sim.simulate(0.05, 1000)
net.setInputs(false, Array(false, false, true, true))
sim.simulate(0.05, 10000)
